...
const recordsDeleteA = `-- name: RecordsDeleteA :exec

DELETE FROM a_records WHERE domain_id = $1 AND ipv4_address = $2
`

type RecordsDeleteAParams struct {
	DomainID    pgtype.Int4 `json:"domain_id"`
	Ipv4Address string      `json:"ipv4_address"`
}
...
func (q *Queries) RecordsDeleteA(ctx context.Context, arg RecordsDeleteAParams) error {
	_, err := q.db.Exec(ctx, recordsDeleteA, arg.DomainID, arg.Ipv4Address)
	return err
}

const recordsDeleteAAAA = `-- name: RecordsDeleteAAAA :exec
DELETE FROM aaaa_records WHERE domain_id = $1 AND ipv6_address = $2
`

type RecordsDeleteAAAAParams struct {
	DomainID    pgtype.Int4 `json:"domain_id"`
	Ipv6Address string      `json:"ipv6_address"`
}

func (q *Queries) RecordsDeleteAAAA(ctx context.Context, arg RecordsDeleteAAAAParams) error {
	_, err := q.db.Exec(ctx, recordsDeleteAAAA, arg.DomainID, arg.Ipv6Address)
	return err
}

const recordsDeleteCAA = `-- name: RecordsDeleteCAA :exec
DELETE FROM caa_records WHERE domain_id = $1 AND tag = $2 AND value = $3
`

type RecordsDeleteCAAParams struct {
	DomainID pgtype.Int4 `json:"domain_id"`
	Tag      string      `json:"tag"`
	Value    string      `json:"value"`
}

func (q *Queries) RecordsDeleteCAA(ctx context.Context, arg RecordsDeleteCAAParams) error {
	_, err := q.db.Exec(ctx, recordsDeleteCAA, arg.DomainID, arg.Tag, arg.Value)
	return err
}

const recordsDeleteCNAME = `-- name: RecordsDeleteCNAME :exec
DELETE FROM cname_records WHERE domain_id = $1 AND target = $2
`

type RecordsDeleteCNAMEParams struct {
	DomainID pgtype.Int4 `json:"domain_id"`
	Target   string      `json:"target"`
}

func (q *Queries) RecordsDeleteCNAME(ctx context.Context, arg RecordsDeleteCNAMEParams) error {
	_, err := q.db.Exec(ctx, recordsDeleteCNAME, arg.DomainID, arg.Target)
	return err
}

const recordsDeleteDNSKEY = `-- name: RecordsDeleteDNSKEY :exec
DELETE FROM dnskey_records WHERE domain_id = $1 AND public_key = $2
`

type RecordsDeleteDNSKEYParams struct {
	DomainID  pgtype.Int4 `json:"domain_id"`
	PublicKey string      `json:"public_key"`
}

func (q *Queries) RecordsDeleteDNSKEY(ctx context.Context, arg RecordsDeleteDNSKEYParams) error {
	_, err := q.db.Exec(ctx, recordsDeleteDNSKEY, arg.DomainID, arg.PublicKey)
	return err
}

const recordsDeleteDS = `-- name: RecordsDeleteDS :exec
DELETE FROM ds_records WHERE domain_id = $1 AND digest = $2
`

type RecordsDeleteDSParams struct {
	DomainID pgtype.Int4 `json:"domain_id"`
	Digest   string      `json:"digest"`
}

func (q *Queries) RecordsDeleteDS(ctx context.Context, arg RecordsDeleteDSParams) error {
	_, err := q.db.Exec(ctx, recordsDeleteDS, arg.DomainID, arg.Digest)
	return err
}

const recordsDeleteMX = `-- name: RecordsDeleteMX :exec
DELETE FROM mx_records WHERE domain_id = $1 AND preference = $2 AND target = $3
`

type RecordsDeleteMXParams struct {
	DomainID   pgtype.Int4 `json:"domain_id"`
	Preference int32       `json:"preference"`
	Target     string      `json:"target"`
}

func (q *Queries) RecordsDeleteMX(ctx context.Context, arg RecordsDeleteMXParams) error {
	_, err := q.db.Exec(ctx, recordsDeleteMX, arg.DomainID, arg.Preference, arg.Target)
	return err
}

const recordsDeleteNS = `-- name: RecordsDeleteNS :exec
DELETE FROM ns_records WHERE domain_id = $1 AND nameserver = $2
`

type RecordsDeleteNSParams struct {
	DomainID   pgtype.Int4 `json:"domain_id"`
	Nameserver string      `json:"nameserver"`
}

func (q *Queries) RecordsDeleteNS(ctx context.Context, arg RecordsDeleteNSParams) error {
	_, err := q.db.Exec(ctx, recordsDeleteNS, arg.DomainID, arg.Nameserver)
	return err
}

const recordsDeletePTR = `-- name: RecordsDeletePTR :exec
DELETE FROM ptr_records WHERE domain_id = $1 AND target = $2
`

type RecordsDeletePTRParams struct {
	DomainID pgtype.Int4 `json:"domain_id"`
	Target   string      `json:"target"`
}

func (q *Queries) RecordsDeletePTR(ctx context.Context, arg RecordsDeletePTRParams) error {
	_, err := q.db.Exec(ctx, recordsDeletePTR, arg.DomainID, arg.Target)
	return err
}

const recordsDeleteRRSIG = `-- name: RecordsDeleteRRSIG :exec
DELETE FROM rrsig_records WHERE domain_id = $1 AND type_covered = $2 AND signer_name = $3
`

type RecordsDeleteRRSIGParams struct {
	DomainID    pgtype.Int4 `json:"domain_id"`
	TypeCovered int32       `json:"type_covered"`
	SignerName  string      `json:"signer_name"`
}

func (q *Queries) RecordsDeleteRRSIG(ctx context.Context, arg RecordsDeleteRRSIGParams) error {
	_, err := q.db.Exec(ctx, recordsDeleteRRSIG, arg.DomainID, arg.TypeCovered, arg.SignerName)
	return err
}

const recordsDeleteSOA = `-- name: RecordsDeleteSOA :exec
DELETE FROM soa_records WHERE domain_id = $1
`

func (q *Queries) RecordsDeleteSOA(ctx context.Context, domainID pgtype.Int4) error {
	_, err := q.db.Exec(ctx, recordsDeleteSOA, domainID)
	return err
}

const recordsDeleteSRV = `-- name: RecordsDeleteSRV :exec
DELETE FROM srv_records WHERE domain_id = $1 AND target = $2 AND port = $3 AND priority = $4
`

type RecordsDeleteSRVParams struct {
	DomainID pgtype.Int4 `json:"domain_id"`
	Target   string      `json:"target"`
	Port     int32       `json:"port"`
	Priority int32       `json:"priority"`
...
func (q *Queries) RecordsDeleteSRV(ctx context.Context, arg RecordsDeleteSRVParams) error {
	_, err := q.db.Exec(ctx, recordsDeleteSRV,
		arg.DomainID,
		arg.Target,
		arg.Port,
		arg.Priority,
...
const recordsDeleteTXT = `-- name: RecordsDeleteTXT :exec
DELETE FROM txt_records WHERE domain_id = $1 AND value = $2
`

type RecordsDeleteTXTParams struct {
	DomainID pgtype.Int4 `json:"domain_id"`
	Value    string      `json:"value"`
}

func (q *Queries) RecordsDeleteTXT(ctx context.Context, arg RecordsDeleteTXTParams) error {
	_, err := q.db.Exec(ctx, recordsDeleteTXT, arg.DomainID, arg.Value)
	return err
}
